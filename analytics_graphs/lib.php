...
function block_analytics_graphs_extend_navigation_course($navigation, $course, $context) {
    ...
    if (has_capability('block/analytics_graphs:viewpages', $context) && $reports) {
        ...
        $url = new moodle_url($CFG->wwwroot.'/blocks/analytics_graphs/grafico_acessos_ativ.php',
            array('id' => $course->id));
        $reportanalyticsgraphs->add(get_string('acessos_notas', 'block_analytics_graphs'), $url,
            navigation_node::TYPE_SETTING, null, null, new pix_icon('i/report', ''));

        $url = new moodle_url($CFG->wwwroot.'/blocks/analytics_graphs/grafico_ultimo_acesso_atividades.php',
            array('id' => $course->id));
        $reportanalyticsgraphs->add(get_string('ult_acesso_ativ', 'block_analytics_graphs'), $url,
            navigation_node::TYPE_SETTING, null, null, new pix_icon('i/report', ''));
