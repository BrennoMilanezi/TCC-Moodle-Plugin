...
$requestedtypes = array("assign", "chat", "choice", "feedback", "forum", "glossary", "quiz", "survey", "wiki", "book",
...
$statistics_antes = $statistics;
$statistics = json_encode($statistics);
/*foreach($statistics_antes as $teste){
    $recurso = str_replace("'", "", $teste['material']);
    echo $recurso;
    $recurso = "'".$recurso."'";
    echo "<br>";
}*/
