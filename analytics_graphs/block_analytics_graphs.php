...
class block_analytics_graphs extends block_base {
    ...
    public function get_content() {
        ...
        $this->content->text .= "<li> <a href= {$CFG->wwwroot}/blocks/analytics_graphs/grafico_acessos_ativ.php?id={$course->id}
                          target=_blank>" . get_string('acessos_notas', 'block_analytics_graphs') . "</a>";

        $this->content->text .= "<li> <a href= {$CFG->wwwroot}/blocks/analytics_graphs/grafico_ultimo_acesso_atividades.php?id={$course->id}
                          target=_blank>" . get_string('ult_acesso_ativ', 'block_analytics_graphs') . "</a>";
        ...
        if ($uselegacypixurl) {
            ...
            $this->content->text .= "<li> <a href= {$CFG->wwwroot}/blocks/analytics_graphs/graphresourceurl.php?id={$course->id}&from=2021-07-15&hidden=true
                          target=_blank>" . get_string('access_to_contents', 'block_analytics_graphs') . "</a>";
        }
